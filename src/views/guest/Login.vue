<template>
  <div class="h-screen grid grid-rows-10 bg-img-login">
    <!-- LITTLE STAMP FIXED -->
    <div class="fixed">
      <div class="bg-av-10 rounded-r-full shadow flex py-1 pr-5 w-80 justify-end items-center gap-5 mt-7">
    ...
    <div class="row-span-6 grid grid-cols-10 pt-16">
      <!-- BIG ORANGE STAMP -->
      <div class="col-span-6 hidden h-full w-full justify-around bg-av-10 rounded-r-full shadow-lg lg:flex pr-5 w-80">
        ...
        <div class="flex items-center justify-center self-center">
          ...
          <router-link class="absolute btn" :to="{ name: 'register' }" >
    ...
    <div class="row-span-4 grid grid-cols-3">
      ...
      <div class="grid grid-cols-12 items-center">
        <div class="col-span-3 flex justify-center">
          <fas class="h-16 text-av-10 shadow-2xl rounded-full p-1" icon="hand-holding-heart"/>
        </div>
...
import TextField from "../../components/AVInput.vue";
